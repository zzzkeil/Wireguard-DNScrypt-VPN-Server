...
clear
echo " ##############################################################################"
echo " # first try to get Wireguard-DNScrypt-VPN-Server  script running for fedora  #"
echo " ##############################################################################"
echo " ##############################################################################"
echo "                                 beta testing                                 #"
echo " ##############################################################################"
...
### fedora
# old 
#yum clean all && yum check-update && yum update ..... 
# new 
dnf -y clean all && dnf check-update && dnf -y update 
dnf -y install qrencode unbound unbound-host python curl
