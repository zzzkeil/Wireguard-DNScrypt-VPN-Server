...
echo -e " ${GRAYB}#${ENDCOLOR} ${GREEN}Wireguard-DNScrypt-VPN-Server setup script for Arch Linux ...........      ${ENDCOLOR}${GRAYB}#${ENDCOLOR}"
echo -e " ${GRAYB}#${ENDCOLOR} ${GREEN}This script is not ready to run ----------------------------------------   ${ENDCOLOR}${GRAYB}#${ENDCOLOR}"

echo -e " ${GRAYB}##############################################################################${ENDCOLOR}"
echo -e " ${GRAYB}#${ENDCOLOR}                 Version 2021.07.25 - changelog on github                   ${GRAYB}#${ENDCOLOR}"
echo -e " ${GRAYB}##############################################################################${ENDCOLOR}"
echo ""
echo ""
echo ""
...
if [[ -e /root/base_setup.README ]]; then
	 ...
	 echo -e " ${YELLOW}Starting download base_setup_arch.sh from my repository${ENDCOLOR}"
	 echo ""
	 echo ""
	 wget -O  base_setup.sh https://raw.githubusercontent.com/zzzkeil/base_setups/master/base_setup_arch.sh
         chmod +x base_setup.sh
	 echo ""
	 echo ""
         echo -e " Now run ${YELLOW}./base_setup_arch.sh${ENDCOLOR} manualy and reboot, then run this script again."
	 echo ""
	 echo ""
	 exit 1
fi
...
clear
echo ""
echo -e "${YELLOW}systemupdate and installs${ENDCOLOR}"


### systemupdate and installs	

#--noconfirm later
pacman -Syu 
pacman -S qrencode unbound unbound-host python curl
