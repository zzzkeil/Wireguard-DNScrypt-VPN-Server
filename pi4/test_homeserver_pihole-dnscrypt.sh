...
echo " This script is not finished for raspberry pi 4 "
echo " This script is not finished for raspberry pi 4 "
echo " This script is not finished for raspberry pi 4 "
echo " This script is not finished for raspberry pi 4 "
echo " This script is not finished for raspberry pi 4 "
...
apt install qrencode python curl -y 
...
wget -O /etc/dnscrypt-proxy/dnscrypt-proxy.tar.gz https://github.com/DNSCrypt/dnscrypt-proxy/releases/download/2.0.42/dnscrypt-proxy-linux_arm-2.0.42.tar.gz
tar -xvzf /etc/dnscrypt-proxy/dnscrypt-proxy.tar.gz -C /etc/dnscrypt-proxy/
mv -f /etc/dnscrypt-proxy/linux-arm/* /etc/dnscrypt-proxy/
#
...
echo "5 extra client.conf and QR Codes files in folder : /etc/wireguard/"
echo ""
echo
echo
