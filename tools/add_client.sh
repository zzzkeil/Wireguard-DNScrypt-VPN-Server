#!/bin/bash
if whiptail --title "New wireguard client" --yesno "Create a new wireguard client ?\n" 15 80; then
echo ""
else
...
#there is now a option in ios client and maybe android to this ...... so not needed anymore?
