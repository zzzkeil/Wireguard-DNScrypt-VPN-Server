...
clear
echo " ####################################################################"
echo " #  This script is only for Debian 9                                #"
...
apt update
apt install linux-headers-$(uname -r) wireguard ufw qrencode unbound unbound-host python -y 
